...
import {
  SITE, WORLD, VERSION, WORLD_SEED, TIER_ORDER, clamp, lerp, smoothstep,
} from './00-config.js';
...
async function main() {
  ...
  window.__seedTime = (h) => pipe.setTimeOfDay(h, true);
